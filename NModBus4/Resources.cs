namespace NModbus4
{
    internal static class Resources
    {
        ...
        {
            public const string Acknowlege = "Acknowlege";

            public const string EmptyEndPoint = "EmptyEndPoint";

            public const string GatewayPathUnavailable = "GatewayPathUnavailable";

            public const string GatewayTargetDeviceFailedToRespond = "GatewayTargetDeviceFailedToRespond";

            public const string HexCharacterCountNotEven = "HexCharacterCountNotEven";

            public const string IllegalDataAddress = "IllegalDataAddress";

            public const string IllegalDataValue = "IllegalDataValue";

            public const string IllegalFunction = "IllegalFunction";

            public const string MemoryParityError = "MemoryParityError";

            public const string NetworkBytesNotEven = "NetworkBytesNotEven";

            public const string SlaveDeviceBusy = "SlaveDeviceBusy";

            public const string SlaveDeviceFailure = "SlaveDeviceFailure";

            public const string TimeoutNotSupported = "TimeoutNotSupported";

            public const string UdpClientNotConnected = "UdpClientNotConnected";

            public const string Unknown = "Unknown";

            public const string WaitRetryGreaterThanZero = "WaitRetryGreaterThanZero";
        }
